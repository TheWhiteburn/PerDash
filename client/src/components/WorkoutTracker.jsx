      ...
      <div>
        ...
        <div className="space-y-3">
          {data.workouts.challenges.filter(c => c.active).map(c => {
            ...
            return (
              <div key={c.id} className="bg-[#0a0a0a] border border-white/15 rounded-lg p-4 shadow-card-white">
                ...
                <div className="space-y-1">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      className="w-full bg-black border border-white/15 rounded-md px-3 py-1.5 text-xs text-gray-200 placeholder-gray-600 outline-none focus:border-gray-400 transition-colors"
                    />
                  </div>
                </div>
              </div>
        ...
        <div className="flex gap-2 mt-3">
          <input
            ...
            className="flex-1 bg-black border border-white/15 rounded-md px-3 py-2 text-sm text-gray-200 placeholder-gray-600 outline-none focus:border-gray-400 transition-colors"
          />
          <button className="px-3 py-2 text-xs bg-white text-gray-900 rounded-md hover:bg-gray-100 transition-all duration-150" onClick={() => { addChallenge(newChallenge); setNewChallenge(''); }}>
            Add
          </button>
        </div>
      </div>
